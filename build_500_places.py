...
core_landmarks = [
  ...
  {"name": "Dreamland Aqua Park UAQ", "emirate": "Umm Al Quwain", "category": "Theme Park", "tag": "Waterpark", "fee": "160 AED", "img": "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=800&q=80", "lat": 25.5861, "lng": 56.6631}
]

prefixes = ["Royal", "Grand", "Heritage", "Sunset", "Crystal", "Golden", "Emerald", "Oasis", "Pearl", "Palm", "Al Hamra", "Al Majaz", "Jumeirah", "Marina", "Corniche", "Desert Rose", "Skyline", "Al Khaleej", "Falcon", "Arabian", "Zabeel", "Saadiyat", "Khor", "Al Zorah", "Al Marjan"]

types = ["Promenade", "Viewpoint", "Beach Club", "Cultural Center", "Heritage Souk", "Adventure Park", "Botanical Garden", "Resort Cove", "Yacht Club", "Ecological Reserve", "Sky Deck", "Art Gallery", "Waterfront Plaza", "Fort Fortress", "Desert Camp", "Marina Walk", "Palace Garden"]
...
print(f"Successfully generated {len(generated_list)} places into data/attractions.json!")
